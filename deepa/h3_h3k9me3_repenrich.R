...
h3k9me3_siC <- read.delim('siControl_H3K9me3_novogene_fraction_counts.txt', header=FALSE)
h3k9me3_siK <- read.delim('siTIP60_H3K9me3_novogene_fraction_counts.txt', header=FALSE)

h3k9me3_siC_class <- read.delim('siControl_H3K9me3_novogene_class_fraction_counts.txt', header=FALSE)
h3k9me3_siK_class <- read.delim('siTIP60_H3K9me3_novogene_class_fraction_counts.txt', header=FALSE)

h3k9me3_siC_family <- read.delim('siControl_H3K9me3_novogene_family_fraction_counts.txt', header=FALSE)
h3k9me3_siK_family <- read.delim('siTIP60_H3K9me3_novogene_family_fraction_counts.txt', header=FALSE)
##################
...
saveRDS(class,"h3k9me3_class_novogene.rds")
saveRDS(fraction,"h3k9me3_fraction_novogene.rds")
saveRDS(family,"h3k9me3_family_novogene.rds")
...
postscript("h3k9me3_class_novogene.ps")
...
postscript("h3k9me3_fraction_novogene.ps",width=12)
